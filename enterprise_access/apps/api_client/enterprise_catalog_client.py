...
from enterprise_access.apps.api_client.constants import autoretry_for_exceptions, retry_backoff_strategy
...
class EnterpriseCatalogApiClient(BaseOAuthClient):
    ...
    @backoff.on_exception(wait_gen=retry_backoff_strategy, exception=autoretry_for_exceptions)
