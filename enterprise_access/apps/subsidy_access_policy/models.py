...
class SubsidyAccessPolicy(TimeStampedModel):
    ...
    def clean_spend_limit(self):
        """
        Validates that spend limits don't exceed available deposits.
        """
...
class SubsidyAccessPolicyRequestAssignmentMixin:
    """
    Mixin providing assignment-based request handling for Browse & Request workflows.
    """
    ...
    def assignment_request_redeem(self, lms_user_id, content_key, all_transactions, metadata=None, **kwargs):
        """
        Redeems content through an assignment-based request workflow.
        """
        ...
        if self.bnr_enabled:
            try:
                ...
                if action is not None:
                    ...
                    action.error_reason = get_error_reason_choice(
                        LearnerCreditRequestActionErrorReasons.FAILED_REDEMPTION
                    )
...
# Re-export supporting models for backwards compatibility.
# Callers can continue to import from enterprise_access.apps.subsidy_access_policy.models
# pylint: disable=wrong-import-position,wrong-import-order,unused-import
from enterprise_access.apps.subsidy_access_policy.models_supporting import (  # noqa: E402,F401
