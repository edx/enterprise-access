...
def get_action_choice(action_key):
    ...
    """
    for choice_value, choice_display in LearnerCreditRequestActionChoices:
...
def get_user_message_choice(message_key):
    ...
    """
    for choice_value, choice_display in LearnerCreditRequestUserMessages.CHOICES:
...
def get_error_reason_choice(error_key):
    ...
    """
    for choice_value, choice_display in LearnerCreditRequestActionErrorReasons.CHOICES:
