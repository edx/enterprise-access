...
class LearnerCreditRequestActions(TimeStampedModel):
    ...
    def create_action(
        ...
        Args:
            ...
            recent_action (str): The type of action taken (must be a valid choice from LearnerCreditRequestActionChoices).
            status (str): The status message (must be a valid choice from LearnerCreditRequestUserMessages.CHOICES).
            error_reason (str, optional): The error reason if applicable (must be a valid choice from LearnerCreditRequestActionErrorReasons.CHOICES).
