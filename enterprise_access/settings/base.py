...
# Essentials cancellation campaigns
BRAZE_SSP_ESSENTIALS_TRIAL_CANCELLATION_CAMPAIGN = os.environ.get(
    'BRAZE_SSP_ESSENTIALS_TRIAL_CANCELLATION_CAMPAIGN', ''
)
BRAZE_SSP_ESSENTIALS_SUBSCRIPTION_CANCELLATION_CAMPAIGN = os.environ.get(
    'BRAZE_SSP_ESSENTIALS_SUBSCRIPTION_CANCELLATION_CAMPAIGN', ''
)
