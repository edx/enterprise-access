...
"""
enterprise_access documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'enterprise_access',  # Repo name
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/enterprise-access",
...
#
# html_title = 'enterprise_access v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Service to manage access to content for enterprise users',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([
        apidoc_path,
        '-o', os.path.join(docs_path, 'generated/'),
        os.path.join(root_path, 'enterprise_access'),
        os.path.join(root_path, 'enterprise_access/migrations'),
    ])
